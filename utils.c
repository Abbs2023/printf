...
/**
 * is_printable - A function that evaluates if a char can be printed
 ...
 * @i: The Index point at which to start appending.
...
/**
 * is_digit - A function that verifies or check if a char is a digit
 * @c: Char to be evaluated
 *
